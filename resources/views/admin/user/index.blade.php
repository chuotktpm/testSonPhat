...
@section('title','SƠN PHÁT || NGƯỜI DÙNG')
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <a href="{{--route('users.create')--}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Tạo Người Dùng"><i class="fas fa-plus"></i> Tạo Người Dùng</a>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{{--route('users.destroy',[$user->id])--}}">
                                    @csrf
                                    @method('delete')
                                    <button class="btn btn-danger btn-sm dltBtn" data-id={{$user->id}} data-toggle="tooltip" data-placement="bottom" title="Delete" style="height:30px; width:30px;border-radius:50%"><i class="fas fa-trash-alt"></i></button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
